...
To create a configuration file for `lintr`. In the file created (`.lintr`), you can set a custom configuration as needed for your package (see the [lintr vignette](https://lintr.r-lib.org/articles/lintr.html)).
...
Some other resources for writing better code:

- [Tidy design principles](https://design.tidyverse.org/) by Hadley Wickham
- [The Programmatic Programmer](https://pragprog.com/titles/tpp20/the-pragmatic-programmer-20th-anniversary-edition/) by David Thomas, Andrew Hunt
